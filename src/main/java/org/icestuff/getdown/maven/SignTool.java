...
public interface SignTool {
	 ...
	 *
	 * @param keystore
	 *            keystore location to find
	 * @param workingKeystore
	 *            location where to copy keystore if coming from an url or from
	 *            classpath
	 * @param classLoader
	 *            classloader where to find keystore in classpath
	 * @return the file location of the keystore saved if required in working
	 *         directory or {@code null} if could not locate keystore.
	 ...
	 *            sign configuration
	 * @param keystoreFile
	 *            location of the keystore to generate
	 * @throws MojoExecutionException
	 *             if something wrong occurs
	 */
	 ...
	 *            sign configuration
	 * @param jarFile
	 *            location of the jar to sign
	 * @param signedJar
	 *            optional location of the signed jar to produce (if not set,
	 *            will use the original location)
	 * @throws MojoExecutionException
	 *             if something wrong occurs
	 */
	 ...
	 *
	 * @param jarFile
	 *            location of the jar to unsign
	 * @param verbose
	 *            flag to display verbose logs
	 * @throws MojoExecutionException
	 *             if something wrong occurs
	 * @since 1.0-beta-4
	 */
